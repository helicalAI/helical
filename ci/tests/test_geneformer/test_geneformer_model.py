...
class TestGeneformer:
    ...
    @pytest.mark.parametrize("model_name,emb_layer,expected_error", [("gf-6L-30M-i2048", -1, "No Error"), ("gf-6L-30M-i2048", 7, "Error"), ("gf-12L-30M-i2048", 6, "No Error"), ("gf-20L-95M-i4096", 23, "Error")])
    def test_embedding_layer_error(
        self, model_name, emb_layer, expected_error
    ):
        config = GeneformerConfig(model_name=model_name, batch_size=5, emb_layer=emb_layer)
    ...
    @pytest.mark.parametrize("model_name,emb_layer", [("gf-6L-30M-i2048", -1), ("gf-6L-30M-i2048", 3), ("gf-12L-30M-i2048", 6), ("gf-20L-95M-i4096", -1)])
    def test_layer_to_quant(
        self, model_name, emb_layer
    ):
        config = GeneformerConfig(model_name=model_name, batch_size=5, emb_layer=emb_layer)
        geneformer = Geneformer(config)
