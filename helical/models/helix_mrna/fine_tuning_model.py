...
class HelixmRNAFineTuningModel(HelicalBaseFineTuningModel, HelixmRNA):
    ...
    helixr_config : HelixRConfig
        The configuration object for the Helix_mRNA model. The same config object can be used for both the HelixmRNA and HelixRFineTuningModel.
    ...
    def _forward(self, input_ids, special_tokens_mask):
        """Forward pass for the Helix-mRNA fine-tuning model.
    ...
    def train(
            self,
            train_dataset: HelixmRNADataset, 
            ...
            validation_dataset: Optional[HelixmRNADataset] = None,
        ...
        trainable_layers : int, optional, default = 4
    ...
    def get_outputs(self, dataset: HelixmRNADataset) -> np.ndarray:
